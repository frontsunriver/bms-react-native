            ...
            <View style={{flexDirection: 'row', margin: 10, justifyContent: 'space-between'}}>
                <TouchableOpacity style={styles.touchableStyle} onPress={() => {
                    ...
                    <View style={{flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
                        ...
                        <Text style={{fontSize: 15, marginTop: 5}}>PENDING REQUEST</Text>
                    </View>
                </TouchableOpacity>
                <TouchableOpacity style={styles.touchableStyle} onPress={() => {
                    ...
                    <View style={{flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
                        ...
                        <Text style={{fontSize: 15, marginTop: 5}}>ARCHIEVED REQUEST</Text>
                    </View>
                </TouchableOpacity>
            </View>
            <View style={{flexDirection: 'row', margin: 10, justifyContent: 'space-between'}}>
                ...
                <TouchableOpacity style={styles.touchableStyle} onPress={() => {
                    NavigatService.navigate(Routes.MESSAGES_SCREEN)
                }}>
                    <View style={{flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>

            ...
            <View style={{paddingBottom: 100}}>
              <View style={{flexDirection: 'column', justifyContent: 'center', padding: 20}}>
                ...
                <View style={{flexDirection: 'row', justifyContent: 'flex-start'}}>
                  ...
                  <TextInput style={styles.textfield} name="name" onChangeText={text => setName(text)}/>
                </View>
                <View style={{flexDirection: 'row', justifyContent: 'flex-start'}}>
                  <Text style={{width: '50%', marginTop: 15}}>{t('Tenant Email')}</Text>
                  <TextInput style={styles.textfield} name="email" onChangeText={text => setEmail(text)}/>
                </View>
                <View style={{flexDirection: 'row', justifyContent: 'flex-start'}}>
                  <Text style={{width: '50%', marginTop: 15}}>{t('Tenant Mobile')}</Text>
                  <TextInput style={styles.textfield} name="mobile" onChangeText={text => setMobile(text)}/>
                </View>
